...
function startBrowser(){
    ...
    execSeries(['DISPLAY=:0 sudo -u chip chromium-browser --incognito --hide-scrollbars --kiosk http://localhost:3111/ '], (err, stdouts, stderrs) => {//finally starts up withD DOSPLAY:0  -- WHO KNOWS WHY?
        if (err) {
            console.log(err);
            throw err;
        }
