...
function startBrowser(){
    ...
    execSeries(['DISPLAY=:0 sudo -u fa chromium-browser --incognito  --kiosk --hide-scrollbars http://localhost:3111/ '], (err, stdouts, stderrs) => {//finally starts up withD DOSPLAY:0  -- WHO KNOWS WHY?
        if (err) {
            console.log(err);
            throw err;
        }
