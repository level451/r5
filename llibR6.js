    ...
    if(direction == 'up'){
       backlightLevel +=1;
        if(backlightLevel < wiz.Backlight*backlightNanoPiMax/100){
            setTimeout(function(){exports.backlight(backlightLevel, "up")}, 20*wiz.FadeIn*(Math.exp(1/wiz.FadeIn))^2);
        }
        ...
        backlightLevel -=1;
        if(backlightLevel > 0){
            setTimeout(function(){exports.backlight(backlightLevel, "down")},1* wiz.FadeOut*Math.exp(1/wiz.FadeIn));
        }
    }
