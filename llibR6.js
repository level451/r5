    ...
    if(direction == 'up'){
       backlightLevel +=1;
        if(backlightLevel < wiz.Backlight*backlightNanoPiMax/100){
            setTimeout(function(){exports.backlight(backlightLevel, "up")}, 10*wiz.FadeIn*(Math.exp(1/wiz.FadeIn))^2);
        }
        ...
        backlightLevel -=1;
        if(backlightLevel > 0){
            setTimeout(function(){exports.backlight(backlightLevel, "down")},10* wiz.FadeOut*Math.exp(1/wiz.FadeIn));
        }
    }
