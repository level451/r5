...
exports.backlight = function(value,direction){
    ...
    console.log("Backlight request: " + backlightLevel + "  direction is: " + direction + " delay is: "+ wiz.FadeIn*(Math.pow(100,1/(backlightLevel+1))) );

    if(direction == 'up'){
       backlightLevel +=1;
        if(backlightLevel < wiz.Backlight*backlightNanoPiMax/100){
            timerBacklightOn = setTimeout(function(){exports.backlight(backlightLevel, "up")}, wiz.FadeIn*(Math.pow(100,1/(backlightLevel+1))));
        }
